...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="/">작게/크게</a>
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item active">
         ...
         <i class="fas fa-fw fa-tachometer-alt"></i>
          ...
          <a class="dropdown-item" href="/admin/shop/allReply">상품 소감</a>
      ...
      <li class="nav-item">
         <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <a class="dropdown-item" href="/admin/shop/orderTek">배송관리</a>
      ...
      <li class="nav-item">
        <a class="nav-link dropdown-toggle" href="/admin/list" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <a class="dropdown-item" href="#">게시판 설정</a>
