...
function init(){
	...
	var confmKey = "devU01TX0FVVEgyMDE5MTAwNzA5NTYzODEwOTA3NTg=";//승인키
...
<body onload="init();">
	<form id="form" name="form" method="post">
		<input type="hidden" id="confmKey" name="confmKey" value="devU01TX0FVVEgyMDE5MTAwNzA5NTYzODEwOTA3NTg="/>
		<input type="hidden" id="returnUrl" name="returnUrl" value="/sample2"/>
		<input type="hidden" id="resultType" name="resultType" value="1"/> // resultType항목 추가(2016.10.06)
