	...
	<div class="member-container">
		...
		<div id="box-tab-idpwfind" class="box-tab-idpwfind uxetabs">
			<ul class="box-tab-idpwfind_navigation">
				<li class="box-tab-idpwfind_navigation-item">
				<a class="box-tab-idpwfind_navigation-link">회원 탈퇴</a>
			</ul>
			...
			<table class="find--table">
				...
				<tr>
					...
					<td><input class="find--name-tf" type="password" id="pass" name="pass" /></td>
				</tr>
			...
			<div class="card-header py-3" align="right">
				<button class="main-search-btn" type="submit" name="remember-me">회원 탈퇴</button>
				<button class="main-search-btn"><a href="/">처음으로</a></button>
			</div>
		</div>
	</div>
</form>
