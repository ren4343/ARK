				...
				<c:choose>
					<c:when test="${mno == 1}">
						<a href='javascript: like_func();'><img
							style="width: 80px; height: 80px;" src='/resources/images/h1.jpg'
							id='like_img' name='like_img'></a>
					</c:when>

					<c:otherwise>
						<a href='/customLogin'><img style="width: 80px; height: 80px;"
							src='/resources/images/h1.jpg'></a>
					</c:otherwise>
				</c:choose>
   ...
   $.ajax({
	...
	<div class="srlite_container" style="padding: 450px 0 17px;">
		<div class="xans-element- xans-srlite xans-srlite-display">
			<h3>WISH PRODUCT LIST</h3>
			<div class="banner_wraper">
				<img src="/resources/images/2019/27168.jpg"> <img
					src="/resources/images/2019/273648.jpg"> <img
					src="/resources/images/2019/7cdd.jpg"> <img
					src="/resources/images/2019/935.jpg"> <img
					src="/resources/images/2019/9863e.jpg"> <img
					src="/resources/images/2019/9a52ed.jpg"> <img
					src="/resources/images/2019/efe64.jpg"> <img
					src="/resources/images/2019/2965.jpg"> <img
					src="/resources/images/2019/744.jpg"> <img
					src="/resources/images/2019/836.jpg">
			</div>
		</div>
	</div>
