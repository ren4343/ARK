...
<div class="contents2">
	<div class="contai6">
		...
		<div class="xans-board-product">
			<a class="prdThumb"><img style="width: 200px; height: 150px;"
				src="/resources/images/upload${review.gdsthumbimg}"></a>
			<div class="prdInfo">
				<h3>
					<a href="/product/detail.html?product_no=2799">퍙's pick 크레스티드
						게코 31번</a>
				</h3>
				<p class="price">120,000원</p>
				<p class="button">
					<a href="/product/detail.html?product_no=2799" title="새창으로 이동"><img
