...
private ShopService ss;
  ...
  @RequestMapping(value = "/orderView", method = RequestMethod.GET) public void
  getOrderList(HttpSession session,
  ...
  order.setUserId(userId); order.setOrderId(orderId);
